          ...
          <div className="flex items-center gap-4 md:gap-8 pl-4">
            ...
            <button className="flex items-center gap-3 md:gap-4 pl-3 pr-1.5 py-1.5 rounded-2xl hover:bg-slate-50 transition-all group">
              <div className="text-right hidden sm:block">
                <p className="text-[13px] font-bold text-slate-900 leading-none">Super Admin</p>
                <p className="text-[10px] text-slate-500 mt-1.5 uppercase tracking-widest font-bold">Platform Owner</p>
              </div>
              <div className="w-9 h-9 md:w-10 md:h-10 rounded-xl bg-slate-100 border border-slate-200 overflow-hidden shadow-sm group-hover:shadow-md transition-all">
                <img src="/admin-avatar.png" alt="Profile" className="w-full h-full object-cover" onError={(e) => {
